...
- 💸 **Movimenti** - spese, entrate e trasferimenti tra conti, registrabili in 2-3 tap, con data e ora modificabili; l'eliminazione dall'editor si annulla con un tap (undo), senza dialog di conferma
...
- 🌍 **Multi-valuta** - ogni movimento conserva importo e valuta originali; nei trasferimenti tra valute diverse l'editor mostra il tasso di cambio implicito nei due importi digitati
