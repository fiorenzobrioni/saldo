...
**Decisioni:** nessuna decisione di prodotto nuova, solo allineamento del documento a decisioni gia prese (ADR 17 e 38). Nell'unico punto in cui la v1.5 resta nominata, la nota della roadmap che ne spiega la chiusura, il riferimento e voluto: serve a chi ritrova il termine nei commit e nel devlog.
