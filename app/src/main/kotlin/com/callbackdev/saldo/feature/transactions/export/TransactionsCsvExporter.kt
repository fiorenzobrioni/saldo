...
class TransactionsCsvExporter @Inject constructor(
    ...
    suspend fun export(
        ...
        val csv = TransactionCsvBuilder.build(
            ...
            labels = columnLabels(),
            separator = separator,
            yesMark = context.getString(R.string.csv_value_yes),
        )
    ...
    private fun columnLabels(): CsvColumnLabels = CsvColumnLabels(
        ...
        counterparty = context.getString(R.string.csv_header_counterparty),
        excludedFromStats = context.getString(R.string.csv_header_excluded_from_stats),
        refund = context.getString(R.string.csv_header_refund),
