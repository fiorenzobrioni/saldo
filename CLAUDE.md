...
- **Il corpo della release non è il file delle note**: nel file dentro il repo i link sono relativi (`../../README.md`) e lì sono corretti; nel corpo di una release GitHub li risolve rispetto a `/<owner>/<repo>/releases/tag/<tag>`, quindi finiscono su percorsi inesistenti e danno 404. Prima di pubblicare, generare una copia del testo con i link assoluti puntati al **tag della release** (`https://github.com/<owner>/<repo>/blob/vX.Y.Z/...`, la sorgente di quella versione, non `main`, che diverge dal testo delle note) e passare quella a `--notes-file`. Mai il file del repo così com'è: la v1.0.0, la v2.0.0 e la v2.1.0 sono state pubblicate tutte tre con i link rotti, e corrette dopo.
